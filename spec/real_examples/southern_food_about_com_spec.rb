...
describe Hangry do
  ...
  context "southernfood.about.com recipe" do
    before(:all) do
      @html = File.read("spec/fixtures/southernfood.about.com.html")
      @parsed = Hangry.parse(@html)
    end
    subject { @parsed }

    it "should use a non-standard parser" do
      expect(Hangry::ParserSelector.new(@html).parser).to be_an_instance_of(Hangry::Parsers::NonStandard::SouthernFoodParser)
    end
